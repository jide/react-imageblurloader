...
var ImageBlurLoader = (function (_Component) {
  ...
  _createClass(ImageBlurLoader, [{
    ...
    value: function handleLoad() {
      (0, _moveit.transition)(_react2['default'].findDOMNode(this.refs.preview), this.props.animation);
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement('img', { ref: 'image', style: imageStyle, src: this.props.src, onLoad: this.handleLoad }),
        _react2['default'].createElement('img', { style: blurStyle, src: 'data:image/png;base64,' + this.props.preview, ref: 'preview' })
      );
    }
  }]);
